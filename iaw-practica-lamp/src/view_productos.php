...
$result = mysqli_query($mysqli, "SELECT producto.nombre AS nombre_producto, producto.codigo AS codigo_producto, producto.precio AS precio_producto, fabricante.nombre AS nombre_fabricante, fabricante.codigo AS codigo_fabricante, producto.imagen FROM producto INNER JOIN fabricante ON producto.codigo_fabricante=fabricante.codigo WHERE producto.codigo = ".$codigo );
?>
